...
class Entity:
    ...
    def move_astar(self, target, entities, game_map):
        ...
        # The path size matters if you want the monster to use alternative longer paths (for example through other rooms
        ...
        if not libtcod.path_is_empty(my_path) and libtcod.path_size(my_path) < 25:
            # Find the coordinates in the computed full path
